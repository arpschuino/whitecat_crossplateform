...
// 2:artnet IN // 3: DMX IN //4 video // 5 memoire // 6 lecteur audio volume 7 pan 8 picth / 9 :vide et clearé / 10:
// direct chan mode 11:FX // 12: Grid // 13: groupe de faders // 14:Mover // 15: Draw // 16: echo
...
unsigned char
    FaderDoDmx[49][514]; // la sortie de chaque fader // passé à 49 pour éviter debordement pointeur ECHO SNAP 19/12/14
...
int index_blink_change_memories =
    0; // si on demande d afficher les changements entre sequenciel modifie ( sc-preset) et les mémoires
...
float shape_attributes[nbre_symbol_per_layer]
                      [5]; // size angle et accessoires 0= general size 1= rotation 2 size x 3 size y 4 oepning angle
...
float snap_shape_attributes[nbre_symbol_per_layer][5]; // size angle et accessoires 0= general size 1= rotation 2 size x
                                                       // 3 size y 4 oepning angle
