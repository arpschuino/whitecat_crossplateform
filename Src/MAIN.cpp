...
void ticker() {
    ...
    if (index_is_saving == 0 && init_done == 1 && index_writing_curve == 0 && index_quit == 0) {
        ...
        //   tick suivant du merger (50Hz) : il faut donc garder le rendu actif QUELQUES frames APRES
        //   la fin du flash, sinon l'ecran reste fige sur la valeur haute jusqu'au mouvement souris.
        {
