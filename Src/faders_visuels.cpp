...
int lfo_fader_functions(int cmptfader, int x, int y, int espacement) {
    ...
    Line(Vec2D(x + (cmptfader * espacement) + 64, y + 370), Vec2D(x + (cmptfader * espacement) + 64, y + 400))
        .Draw(CouleurLigne);
    ...
    // icones en vectoriel
    // up
    Line(Vec2D(x + (cmptfader * espacement) + 117, y + 245), Vec2D(Vec2D(x + (cmptfader * espacement) + 117, y + 260)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 117, y + 245), Vec2D(Vec2D(x + (cmptfader * espacement) + 110, y + 250)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 117, y + 245), Vec2D(Vec2D(x + (cmptfader * espacement) + 124, y + 250)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 110, y + 245), Vec2D(Vec2D(x + (cmptfader * espacement) + 125, y + 245)))
        .Draw(CouleurLigne);
    // down
    Line(Vec2D(x + (cmptfader * espacement) + 117, y + 285), Vec2D(Vec2D(x + (cmptfader * espacement) + 117, y + 300)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 110, y + 295), Vec2D(Vec2D(x + (cmptfader * espacement) + 117, y + 300)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 124, y + 295), Vec2D(Vec2D(x + (cmptfader * espacement) + 117, y + 300)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 110, y + 300), Vec2D(Vec2D(x + (cmptfader * espacement) + 125, y + 300)))
        .Draw(CouleurLigne);
    // saw
    Line(Vec2D(x + (cmptfader * espacement) + 110, y + 325), Vec2D(Vec2D(x + (cmptfader * espacement) + 115, y + 340)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 115, y + 340), Vec2D(Vec2D(x + (cmptfader * espacement) + 120, y + 325)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 120, y + 325), Vec2D(Vec2D(x + (cmptfader * espacement) + 125, y + 340)))
        .Draw(CouleurLigne);
    ...
    Line(Vec2D(x + (cmptfader * espacement) + 75, y + 330), Vec2D(Vec2D(x + (cmptfader * espacement) + 87, y + 330)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 87, y + 330), Vec2D(Vec2D(x + (cmptfader * espacement) + 87, y + 340)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 87, y + 340), Vec2D(Vec2D(x + (cmptfader * espacement) + 84, y + 335)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 87, y + 340), Vec2D(Vec2D(x + (cmptfader * espacement) + 90, y + 335)))
        .Draw(CouleurLigne);
    // icone next step backward
    Line(Vec2D(x + (cmptfader * espacement) + 75, y + 295), Vec2D(Vec2D(x + (cmptfader * espacement) + 87, y + 295)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 87, y + 295), Vec2D(Vec2D(x + (cmptfader * espacement) + 87, y + 285)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 87, y + 285), Vec2D(Vec2D(x + (cmptfader * espacement) + 84, y + 290)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 87, y + 285), Vec2D(Vec2D(x + (cmptfader * espacement) + 90, y + 290)))
        .Draw(CouleurLigne);
    // liaison steps
    Line(Vec2D(x + (cmptfader * espacement) + 83, y + 305), Vec2D(Vec2D(x + (cmptfader * espacement) + 83, y + 320)))
        .Draw(CouleurLigne);

    // icone cycle steps up and down
    Line(Vec2D(x + (cmptfader * espacement) + 47, y + 330), Vec2D(Vec2D(x + (cmptfader * espacement) + 47, y + 340)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 47, y + 340), Vec2D(Vec2D(x + (cmptfader * espacement) + 44, y + 335)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 47, y + 340), Vec2D(Vec2D(x + (cmptfader * espacement) + 50, y + 335)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 47, y + 330), Vec2D(Vec2D(x + (cmptfader * espacement) + 47, y + 325)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 47, y + 325), Vec2D(Vec2D(x + (cmptfader * espacement) + 44, y + 330)))
        .Draw(CouleurLigne);
    Line(Vec2D(x + (cmptfader * espacement) + 47, y + 325), Vec2D(Vec2D(x + (cmptfader * espacement) + 50, y + 330)))
        .Draw(CouleurLigne);
    // liaison steps
    Line(Vec2D(x + (cmptfader * espacement) + 60, y + 332), Vec2D(Vec2D(x + (cmptfader * espacement) + 70, y + 332)))
        .Draw(CouleurLigne);
    ...
    // Flash
    if (window_focus_id == W_FADERS && mouse_x > x + (cmptfader * espacement) + 138 &&
        mouse_x < x + (cmptfader * espacement) + 163 && mouse_y > y + 320 && mouse_y < y + 345) {
    ...
    if (window_focus_id == W_FADERS) {
        ...
        if (Midi_Faders_Affectation_Type != 0) {
            // sab 02/03/2014 IMPACT if( mouse_x>x+(cmptfader*espacement)-5 && mouse_x<x+(cmptfader*espacement)+132 &
            // mouse_y>y+375 && mouse_y<y+400)
            if (mouse_x > x + (cmptfader * espacement) - 5 && mouse_x < x + (cmptfader * espacement) + 132 &&
                mouse_y > y + 375 && mouse_y < y + 400) {
                LFOSpeedFrame.DrawOutline(CouleurBlind);
                LFOSpeed.Draw(CouleurBlind);
            } else if (mouse_x > (x + (cmptfader * espacement) - 6) && mouse_x < (x + (cmptfader * espacement) + 19) &&
                       mouse_y > (y + 320) && mouse_y < (y + 345)) {
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) - 6, y + 320));
                GlobalBut.DrawOutline(CouleurBlind);
            } else if (mouse_x > x + (cmptfader * espacement) + 105 && mouse_x < x + (cmptfader * espacement) + 130 &&
                       mouse_y > y + 240 && mouse_y < y + 265) {
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) + 105, y + 240));
                GlobalBut.DrawOutline(CouleurBlind);
            } else if (mouse_x > x + (cmptfader * espacement) + 105 && mouse_x < x + (cmptfader * espacement) + 130 &&
                       mouse_y > y + 280 && mouse_y < y + 305) {
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) + 105, y + 280));
                GlobalBut.DrawOutline(CouleurBlind);
            } else if (mouse_x > x + (cmptfader * espacement) + 105 && mouse_x < x + (cmptfader * espacement) + 130 &&
                       mouse_y > y + 320 && mouse_y < y + 345) {
            ...
            else if (mouse_x > x + (cmptfader * espacement) + 70 && mouse_x < x + (cmptfader * espacement) + 95 &&
                     mouse_y > y + 280 && mouse_y < y + 305) {
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) + 70, y + 280));
                GlobalBut.DrawOutline(CouleurBlind);
            } else if (mouse_x > x + (cmptfader * espacement) + 70 && mouse_x < x + (cmptfader * espacement) + 95 &&
                ...
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) + 70, y + 320));
                GlobalBut.DrawOutline(CouleurBlind);
            } else if (mouse_x > x + (cmptfader * espacement) + 35 && mouse_x < x + (cmptfader * espacement) + 60 &&
                       mouse_y > y + 320 && mouse_y < y + 345) {
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) + 35, y + 320));
                GlobalBut.DrawOutline(CouleurBlind);
            }

            else if (mouse_x > x + (cmptfader * espacement) + 138 && mouse_x < x + (cmptfader * espacement) + 153 &&
                     mouse_y > y + 240 && mouse_y < y + 265) {
                GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) + 138, y + 240));
                GlobalBut.DrawOutline(CouleurBlind);
            } else if (mouse_x > x + (cmptfader * espacement) + 138 && mouse_x < x + (cmptfader * espacement) + 153 &&
        ...
        if (mouse_x > (x + (cmptfader * espacement) - 6) && mouse_x < (x + (cmptfader * espacement) + 19) &&
            mouse_y > (y + 320) && mouse_y < (y + 345) && (index_do_dock == 1 || index_main_clear == 1)) {
            GlobalBut.MoveTo(Vec2D(x + (cmptfader * espacement) - 6, y + 320));
...
int MoveFaderSpace(int ydelimitation) {
    ...
    Line Delimitation(Vec2D(scroll_faderspace + 50, ydelimitation - 5),
                      Vec2D(scroll_faderspace + 50, ydelimitation + 25));
    ...
    if (mouse_y >= ydelimitation - 5 && mouse_y <= ydelimitation + 35 && window_focus_id == W_FADERS) {
        ...
        if (Midi_Faders_Affectation_Type != 0) {
            ...
            if (mouse_x > scroll_faderspace && mouse_x < scroll_faderspace + 50) {
                ...
                sprintf(string_last_midi_id, "MoveFaderSpace LR is Ch: %d Pitch: %d Typ: %s", miditable[1][767],
                        miditable[2][767], thetypinfo);
            }
        }
        // UP DOWN
        if (mouse_x > scroll_faderspace + 50 && mouse_x < scroll_faderspace + 100) {
            ...
            sprintf(string_last_midi_id, "MoveFaderSpace UP is Ch: %d Pitch: %d Typ: %s", miditable[1][1635],
                    miditable[2][1635], thetypinfo);
        }
    }
...
int Lock_Preset_Call(int xf, int yf) {
    ...
    for (int cm = 0; cm < 2; cm++) {
        for (int ll = 0; ll < 4; ll++) {
            ...
            if (window_focus_id == W_MINIFADERS && Midi_Faders_Affectation_Type != 0 && mouse_x > xf + (cm * 55) - 5 &&
                mouse_x < xf + (cm * 55) + 40 && mouse_y > yf + (ll * 55) && mouse_y < yf + (ll * 55) + 45) {
                // config midi
...
int Commandes_faders_generales(int xf, int yf) {
    ...
    for (int u = 0; u < 8; u++) {
        ...
        if (window_focus_id == W_MINIFADERS && Midi_Faders_Affectation_Type != 0 && mouse_x > xf && mouse_x < xf + 72 &&
            mouse_y > yf + (50 * u) && mouse_y < yf + (50 * u) + 25) {
...
int FaderSpace(int x, int y, int espacement, int nbr_fader) {
    ...
    if (LargeurEspaceFaderSize != largeur_ecran) {
        ...
        Line bord(Vec2D(LargeurEspaceFaderSize, y - 80 + 10),
                  Vec2D(LargeurEspaceFaderSize, y - 80 + hauteur_ecran - 15));
    ...
    for (int cmptfader = 0; cmptfader < core_user_define_nb_faders; cmptfader++) {
        ...
        if (((x + (cmptfader * espacement) + espacement) > 0) &&
            ...
            // separateur
            Line(Vec2D(x + (cmptfader * espacement) - 20, y - 50), Vec2D(x + (cmptfader * espacement) - 20, y + 400))
                .Draw(CouleurLigne);
            ...
            Rect Midireceive(Vec2D(x + (cmptfader * espacement) + 135, y - 35),
                             Vec2D(15, 15)); // box du boutton assignation rapide
            ...
            for (int dd = 0; dd < core_user_define_nb_docks; dd++) {
                ...
                if (window_focus_id == W_FADERS && mouse_x >= (x + (cmptfader * espacement) + 70) &&
                    mouse_x <= (x + (cmptfader * espacement) + 120) && mouse_y >= (y + (dd * 40)) &&
                    mouse_y <= (y + (dd * 40) + 20) && index_over_function_call == 0) {
                ...
                case 5: // si le doc contient une memoire
                    ...
                    if (MemoiresExistantes[DockHasMem[cmptfader][dd]] ==
                        0) // si mem detruite plus tard affichage d un pb d affcetation
                    {
                ...
                case 8:
                    ...
                    petitchiffre.Print(string_docktypaudiopicth, x + ((cmptfader * espacement) + 77),
                                       y + 15 + (dd * 40));
                    break;
                case 9: // no content
                ...
                if (window_focus_id == W_FADERS && Midi_Faders_Affectation_Type != 0 &&
                    mouse_x >= (x + (cmptfader * espacement) + 70) && mouse_x <= (x + (cmptfader * espacement) + 120) &&
            ...
            Line(Vec2D(x + (cmptfader * espacement) + 40, y + 240), Vec2D(x + (cmptfader * espacement) + 55, y + 240))
                .Draw(CouleurLigne);
            Line(Vec2D(x + (cmptfader * espacement) + 55, y + 240), Vec2D(x + (cmptfader * espacement) + 62, y + 244))
                .Draw(CouleurLigne);
            //////////////////////////////////////
            ...
            // commande embeded
            if (DockTypeIs[cmptfader][dock_used_by_fader_is[cmptfader]] == 11 ||
                DockTypeIs[cmptfader][dock_used_by_fader_is[cmptfader]] == 12 ||
                DockTypeIs[cmptfader][dock_used_by_fader_is[cmptfader]] == 6 ||
            ...
            if (window_focus_id == W_FADERS && Midi_Faders_Affectation_Type != 0) {
                if (mouse_x > x + (cmptfader * espacement) + 75 && mouse_x < x + (cmptfader * espacement) + 115 &&
                    mouse_y > y - 30 && mouse_y < y - 20) {
                    char temp_str_tr[72];
                ...
                } else if (mouse_x > x + (cmptfader * espacement) + 135 &&
                           mouse_x < x + (cmptfader * espacement) + 150 && mouse_y > y - 35 && mouse_y < y - 20) {
                ...
                } else if (mouse_y > (y + 280) && mouse_y < (y + 300) && mouse_x > x + (cmptfader * espacement) &&
                           mouse_x < (x + 40 + (cmptfader * espacement))) {
