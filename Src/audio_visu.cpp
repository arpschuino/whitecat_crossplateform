...
int fader_niveau_son(int xp, int yp, int numero) {
    ...
    if (window_focus_id == 919 && Midi_Faders_Affectation_Type != 0 && mouse_x > xp && mouse_x < xp + 20 &&
        mouse_y >= yp && mouse_y <= yp + 127) {
...
int lecteur_audio(int xp, int yp, int numero) {
    ...
    // SEEKBAR
    {
        ...
        if (length_of_file_in_player[numero] > 0 && player_is_onloopCue[numero]) {
            int in_x = xp + (int)((float)audiofile_cue_in_out_pos[player_has_file_coming_from_pos[numero]][numero][0] /
                                  length_of_file_in_player[numero] * seekbar_w);
            int out_x =
                xp + (int)((float)player_loop_out_position[numero] / length_of_file_in_player[numero] * seekbar_w);
    ...
    if (window_focus_id == 919 && Midi_Faders_Affectation_Type != 0) {
        if (mouse_x > xp && mouse_x < xp + 20 && mouse_y > yp + 35 && mouse_y < yp + 55) {
            Play.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 25 && mouse_x < xp + 45 && mouse_y > yp + 35 && mouse_y < yp + 55) {
            SeekToZero.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 50 && mouse_x < xp + 70 && mouse_y > yp + 35 && mouse_y < yp + 55) {
            GeneralLoop.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 75 && mouse_x < xp + 95 && mouse_y > yp + 35 && mouse_y < yp + 55) {
            SeekToEnd.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp && mouse_x < xp + 28 && mouse_y > yp + 63 && mouse_y < yp + 79) {
            Backward.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 35 && mouse_x < xp + 63 && mouse_y > yp + 63 && mouse_y < yp + 79) {
            Forward.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp && mouse_x < xp + 45 && mouse_y > yp + 88 && mouse_y < yp + 104) {
            Previous.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 50 && mouse_x < xp + 95 && mouse_y > yp + 88 && mouse_y < yp + 104) {
            Next.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 70 && mouse_x < xp + 110 && mouse_y > yp + 60 && mouse_y < yp + 79) {
        ...
        } else if (mouse_x > xp + 210 && mouse_x < xp + 230 && mouse_y > yp + 35 && mouse_y < yp + 55) {
            SeekCue.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 120 + player_pitch[numero] && mouse_x < xp + 150 + player_pitch[numero] &&
                   mouse_y > yp + 110 && mouse_y < yp + 120) {
            PitchMidi.DrawOutline(CouleurBlind);
        } else if (mouse_x > xp + 120 + player_pan[numero] && mouse_x < xp + 150 + player_pan[numero] &&
                   mouse_y > yp + 85 && mouse_y < yp + 95) {
...
int fenetre_audio(int xb, int yb) {
    ...
    for (int y = 1; y < (index_nbre_players_visibles * 6); y++) {
        ...
        if (strcmp(audiofile_name, list_audio_files[audiofile_selected]) == 0 &&
            (audiofile_selected == (y + line_audio))) {
            OverAudioFile.Draw(CouleurBlind);
        }

        if (window_focus_id == 919 && mouse_x > xb + 355 && mouse_x < xb + 505 && mouse_y > (yb + 33 + (y * 20)) &&
            mouse_y < (yb + 48 + (y * 20))) {
    ...
    for (int pl = 0; pl < index_nbre_players_visibles; pl++) {
        for (int co = 0; co < 3; co++) {
            Rect AffectAudioType(Vec2D(xb + 460 + (pl * 30), yb + 90 + (index_nbre_players_visibles * 120) + (co * 20)),
                                 Vec2D(20, 15));
        ...
        petitpetitchiffre.Print(ol::ToString((pl + 1)), xb + 467 + (pl * 30),
                                yb + 85 + (index_nbre_players_visibles * 120));
    }
    ...
    if (index_show_audio_folder_list) {
        ...
        if (nbre_audio_folders == 0) {
            ...
            if (has_scroll) {
                ...
                ArrowDown.Draw(audio_folder_list_scroll < nbre_audio_folders - max_vis ? CouleurGrisAnthracite
                                                                                       : CouleurFond);
                petitpetitchiffre.Print("v", bx + 4, by + bar_h - bar_w + 10);
