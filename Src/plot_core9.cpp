        ...
        do {
            ...
            for(unsigned int a=0;a<(unsigned int)f_name_len;a++)
            {
                if(f.cFileName[a]=='.' && a<=(unsigned int)(f_name_len-3))
                {
                    ...
                    ||(f.cFileName[a+1]=='b' && f.cFileName[a+2]=='m' && f.cFileName[a+3]=='p')
                    ||(f.cFileName[a+1]=='p' && f.cFileName[a+2]=='n' && f.cFileName[a+3]=='g')
                    ||(f.cFileName[a+1]=='J' && f.cFileName[a+2]=='P' && f.cFileName[a+3]=='G')
                    ||(f.cFileName[a+1]=='B' && f.cFileName[a+2]=='M' && f.cFileName[a+3]=='P')
                    ||(f.cFileName[a+1]=='P' && f.cFileName[a+2]=='N' && f.cFileName[a+3]=='G')
                    )
            ...
            if(nrbe_de_fichiers<127 && index_check_is_supported==1)
            {
                sprintf(list_import_plans[nrbe_de_fichiers],f.cFileName);
                nrbe_de_fichiers++;
            }
