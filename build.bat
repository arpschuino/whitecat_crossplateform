...
echo %SRC_F%/devicepatch.cpp >> "%RSP%"
echo %SRC_F%/gdtf_import.cpp >> "%RSP%"
echo %SRC_F%/wc_http.cpp >> "%RSP%"
echo %SRC_F%/gdtf_share.cpp >> "%RSP%"
...
echo %SRC_F%/devicepatch_visu.cpp >> "%RSP%"
...
echo -luser32 -lgdi32 -lwsock32 -liphlpapi -lwininet >> "%RSP%"
